...
func rawGenerateV6(c *gin.Context) []string {
	r := c.Request
	var specEnd []string
...
func checkPosRawV6(c *gin.Context) ([]string, error) {
	r := c.Request
...
// AddRawV6 PUT /raw_v6/{action}/{chain}/{proto}/{iface_in}/{iface_out}/{source}/{destination}/?sports=00&dports=00&tcpflag1=XYZ&tcpflag2=Y&notrack=true
func AddRawV6(c *gin.Context) {
	w := c.Writer
	r := c.Request
...
// DelRawV6 DELTE /raw_v6/{action}/{chain}/{proto}/{iface_in}/{iface_out}/{source}/{destination}/?sports=00&dports=00&tcpflag1=XYZ&tcpflag2=Y&notrack=true
func DelRawV6(c *gin.Context) {
	w := c.Writer
...
// CheckRawV6 GET /raw_v6/{action}/{chain}/{proto}/{iface_in}/{iface_out}/{source}/{destination}/?sports=00&dports=00&tcpflag1=XYZ&tcpflag2=Y&notrack=true
func CheckRawV6(c *gin.Context) {
	w := c.Writer
	r := c.Request
